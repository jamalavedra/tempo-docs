...
<Cards>
  <Card
    description="Learn how to execute swaps against the orderbook"
    to="/guide/stablecoin-dex/executing-swaps"
    icon="lucide:arrow-left-right"
    title="Executing Swaps"
  />
  <Card
    description="Understand the Stablecoin DEX protocol specification"
    to="/protocol/exchange"
    icon="lucide:file-text"
    title="Stablecoin DEX Protocol"
  />
</Cards>
